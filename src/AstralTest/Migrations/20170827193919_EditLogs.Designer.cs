...
namespace AstralTest.Migrations
{
    ...
    [Migration("20170827193919_EditLogs")]
    partial class EditLogs
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("AstralTest.Domain.Entities.ParametrsAction", b =>
                {
                    b.Property<Guid>("Id");

                    b.Property<Guid>("IdAction");

                    b.Property<string>("JsonParametrs");
            ...
            modelBuilder.Entity("AstralTest.Domain.Entities.ParametrsAction", b =>
                {
                    b.HasOne("AstralTest.Domain.Entities.ActionLog", "Action")
                        .WithOne("ParametrsAction")
                        .HasForeignKey("AstralTest.Domain.Entities.ParametrsAction", "IdAction")
                        .OnDelete(DeleteBehavior.Cascade);
                });
