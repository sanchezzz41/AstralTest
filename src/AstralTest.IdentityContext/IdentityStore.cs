   ...
   public class IdentityStore : IUserLockoutStore<User>, IUserPasswordStore<User>, IUserRoleStore<User>
    {
        ...
        public Task<string> GetUserIdAsync(User user, CancellationToken cancellationToken)
       {
        ...
        public async Task<User> FindByIdAsync(string userId, CancellationToken cancellationToken)
        {
            ...
            var user = await _context.Users.FirstOrDefaultAsync(a => a.UserId == guid, cancellationToken);
            return user;
        }
        /// <summary>
        ...
        public async Task<User> FindByNameAsync(string normalizedUserName, CancellationToken cancellationToken)
        {
            ...
            var user = await _context.Users.FirstOrDefaultAsync(a => a.UserName.ToUpper() == normalizedUserName, cancellationToken);
            return user;
        }
        /// <summary>
